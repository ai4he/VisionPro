...
IL_0035:
	{
		...
		String_t* L_10 = V_0;
		bool L_11;
		L_11 = Directory_Exists_m1AC1A8910C9883BD4198ECF585C97F09E23C4702(L_10, NULL);
		if (L_11)
		{
			goto IL_0044;
		}
...
IL_0044:
	{
		...
		String_t* L_44;
		L_44 = String_Format_m74FC0A1259DFA02F3DF6538FC7F3ACF3E1AF0C55(_stringLiteral138C8DE2C1CB9DED85DB8AAFB49C1CF08A14A170, L_40, NULL);
		V_0 = L_44;
		// VLog.D("MicDebug - Writing recording to file: " + path);
		String_t* L_45 = V_0;
		String_t* L_46;
		L_46 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral6BC7B8B30763D35752A71C9CA56135B797B57F9D, L_45, NULL);
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_46, NULL);
		// _fileStream = File.Open(path, FileMode.Create);
		String_t* L_47 = V_0;
		FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8* L_48;
		L_48 = File_Open_m9C6D5876B037A5A8341D216B767D4C8BE7084326(L_47, 2, NULL);
