...
IL_002c:
	{
		...
		L_12 = InputActionReference_op_Implicit_mADEA02525E8CF9211980F437F73DE45414F27E36(L_11, NULL);
...
IL_0027:
	...
	}
	{
		...
		String_t* L_10;
		L_10 = String_Concat_m9B13B47FCB3DF61144D9647DDA05F527377251B0(_stringLiteral22B82FCA983882D991D88BC342332ED586767409, L_9, _stringLiteral17FAC7AA818E6C59FC84A931569B8DA1D4849199, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_LogError_m385F8F46AD9C455E80053F42571A7CE321915C0A(L_10, __this, NULL);
		return;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRDeviceSimulatorUI_OnDestroy_mF98E3E18D765CD201F467EE9431E8D1AC618D6E1 (XRDeviceSimulatorUI_t83558A12FEB0C923A821ED77A9214E829ABA8E53* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		XRDeviceSimulatorUI_Unsubscribe_mE5D7C6EEBD44F3E3784D30C83727F75DB2BB066A(L_63, L_64, NULL);
	}
...
IL_0142:
	{
		...
		String_t* L_90;
		L_90 = String_Concat_m6B0734B65813C8EA093D78E5C2D16534EB6FE8C0(L_87, NULL);
		NullCheck(L_65);
		...
		int32_t L_99;
		L_99 = Cursor_get_lockState_m99E97A23A051AA1167B9C49C3F6E8244E74531AE(NULL);
		G_B13_0 = L_98;
...
IL_0312:
	{
		...
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_127;
		L_127 = Color_get_white_m28BB6E19F27D4EE6858D3021A44F62BC74E20C43_inline(NULL);
		NullCheck(L_126);
...
IL_0359:
	{
		...
		bool L_138;
		L_138 = String_op_Equality_m0D685A924E5CD78078F248ED1726DA5A9D7D6AC0(L_137, _stringLiteral294F098A1D5E681EDEE8F43BFA8F45CFBA5798A7, NULL);
		G_B23_0 = L_134;
		if (L_138)
		{
			G_B24_0 = L_134;
...
IL_0385:
	{
		...
		String_t* L_157;
		L_157 = String_Concat_mF8B69BE42B5C5ABCAD3C176FBBE3010E0815D65D(L_150, _stringLiteral8F8BFCFC439A636B20C06C334A493AB7004843ED, L_156, _stringLiteral44F840CD2F40ADB814D44EA51A7753812FECBF05, NULL);
		V_6 = L_157;
		...
		String_t* L_170;
		L_170 = String_Concat_mF8B69BE42B5C5ABCAD3C176FBBE3010E0815D65D(L_163, _stringLiteral8F8BFCFC439A636B20C06C334A493AB7004843ED, L_169, _stringLiteral44F840CD2F40ADB814D44EA51A7753812FECBF05, NULL);
		V_7 = L_170;
		...
		il2cpp_codegen_runtime_class_init_inline(XRDeviceSimulatorUI_t83558A12FEB0C923A821ED77A9214E829ABA8E53_il2cpp_TypeInfo_var);
		XRDeviceSimulatorUI_Subscribe_m353BC8898DEF0F1F7F9204A5CBC7F4AF072F46CA(L_190, L_191, NULL);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_252 = __this->___m_XRDeviceSimulatorMainPanel_9;
		bool L_253;
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_254 = __this->___m_XRDeviceSimulatorCollapsedPanel_10;
		bool L_255;
...
IL_00b4:
	{
		...
		bool L_22;
		L_22 = Mathf_Approximately_m1C8DD0BB6A2D22A7DCF09AD7F8EE9ABD12D3F620_inline(L_21, (1.0f), NULL);
		...
		bool L_25;
		L_25 = Mathf_Approximately_m1C8DD0BB6A2D22A7DCF09AD7F8EE9ABD12D3F620_inline(L_24, (1.0f), NULL);
